    ...
    <>
      ...
      <div className="flex flex-col shadow-lg rounded-xl overflow-hidden">
        ...
        <div className="flex justify-between items-center px-2 py-2">
          <h3
            className="text-lg font-semibold whitespace-nowrap overflow-hidden text-ellipsis hover:cursor-pointer"
        ...
        <div className="flex text-gray-600 text-[0.7rem] gap-1 relative ps-2 pb-2">
          ...
          <div
            className="absolute rounded-tl-2xl rounded-br-2xl bg-emerald-600 right-0 bottom-0 px-3 text-white text-2xl hover:cursor-pointer"
            onClick={() => setModalOpen(true)}
          >
            +
          </div>
